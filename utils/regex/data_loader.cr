...
class Emoji::Regex::DataLoader
  ...
  def initialize
    @data_lines = read_lines_from_file("/Public/17.0.0/ucd/emoji/emoji-data.txt")
    @variation_sequences_lines = read_lines_from_file("/Public/17.0.0/ucd/emoji/emoji-variation-sequences.txt")
    @sequences_lines = read_lines_from_file("/Public/17.0.0/emoji/emoji-sequences.txt")
    @zwj_sequences_lines = read_lines_from_file("/Public/17.0.0/emoji/emoji-zwj-sequences.txt")
  end
